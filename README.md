...
# 📖 Ruby on Rails Ract Hello World app <a name="about-project"></a>

**Ruby on Rails Ract Hello World app ** A Rails app that serves a React front-end, which displays a random greeting from a list of greetings. The app would be built using the following technologies: Ruby on Rails, React, Redux and PostgreSQL
...
```sh
  cd my-folder
  git clone https://github.com/Elhambasir/ror-helloworld-project-with-webpack.git
```
...
```sh
  cd ror-helloworld-project-with-webpack
  bundle install
```
...
- LinkedIn: [@james-serengia](https://www.linkedin.com/in/james-serengia)
